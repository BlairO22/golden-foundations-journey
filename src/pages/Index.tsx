...
const SingleTestimonial = ({ quote, name, role, image, bg = "section-offwhite" }: { quote: string; name: string; role: string; image: string; bg?: string }) => (
  <section className={`${bg} py-16 md:py-16 px-6`}>
